...
class SDVScore:
    ...
    def average(self) -> float:
        scores = [self.vivienda, self.alimentacion, self.agua, self.salud, 
                  self.educacion, self.trabajo, self.vinculos]
...
class SDVAnalyzer:
    ...
    def estimate_participant_sdv(self, participant_id: int) -> SDVScore:
        ...
        for target in ["vivienda", "alimentacion", "agua", "salud", "educacion", "trabajo", "vinculos"]:
    ...
    def get_community_sdv_status(self) -> Dict[str, Any]:
        ...
        if not participant_ids:
            return {"average_score": 1.0, "dimensions": SDVScore().to_dict(), "count": 0}
        
        total_scores = {
            "vivienda": 0.0, "alimentacion": 0.0, "agua": 0.0, 
            "salud": 0.0, "educacion": 0.0, "trabajo": 0.0, "vinculos": 0.0
        }
