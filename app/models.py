...
class Interchange(db.Model):
    ...
    giver = db.relationship('User', foreign_keys=[giver_id], backref='given_interchanges')
    receiver = db.relationship('User', foreign_keys=[receiver_id], backref='received_interchanges')
