...
**Versión:** 5.6 - Ola 4 · Puente B completo: del matching al contrato activo (firma guiada por el camino /cycle) (DeepSeek)
...
- **593 tests** (593/593 pasando) ✅ (Backend Core + Blocks + Escalas + Quórum + Blindaje + Equidad + Ejecución + Métricas + Check-ins + Verificador Público + Puente B completo + Ruteo SPA)
---
