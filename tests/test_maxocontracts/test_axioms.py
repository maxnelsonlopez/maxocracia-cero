...
from maxocontracts.core.types import SDV, VHV, Participant, Wellness
...
class TestValidateAll:
    ...
    def test_validate_all_success(self):
        ...
        is_valid, results = AxiomValidator.validate_all(
            vhv=vhv, participants=[participant], minimum_sdv=minimum_sdv
        )
    ...
    def test_validate_all_fails_on_gamma(self):
        ...
        is_valid, results = AxiomValidator.validate_all(
            vhv=vhv, participants=[participant], minimum_sdv=SDV()
        )
