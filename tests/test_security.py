...
class TestSecurity(unittest.TestCase):
        ...
        with self.client.application.app_context():
            ...
            try:
                db.execute(
                    ...
                    (self.email, 'Security Test User', generate_password_hash(self.password))
                )
                db.commit()
    ...
    def test_login_brute_force_protection(self):
        ...
        with self.client as client:
            ...
            for _ in range(5):
                ...
                self.assertIn(
                    response.status_code, [400, 401, 429],
        ...
        if response.status_code == 429:
            ...
            assert any(term in str(error_data['error']).lower() 
    ...
    def test_password_strength_enforcement(self):
        ...
        test_cases = [
            ...
            ('nouppercase123', 'Sin mayúsculas', True, 'debe contener al menos una letra mayúscula'),
            ('NOLOWERCASE123', 'Sin minúsculas', True, 'debe contener al menos una letra minúscula'),
            ...
            ('Another$ecure1', 'Válida con símbolos y números', False, 'debería ser aceptada')
        ]
        ...
        for password, desc, should_fail, reason in test_cases:
            ...
            if should_fail:
                ...
                error_data = response.get_json()
                assert 'error' in error_data or 'details' in error_data, \
                    f"Formato de error inesperado: {error_data}"
                    
                # Verificar que tenemos un mensaje de error genérico
                assert 'details' in error_data and 'campo' in error_data['details'], \
                    f"Error inesperado para contraseña '{password}': {error_data}"
                assert error_data['details']['campo'] == 'valor inválido', \
                    f"Mensaje de error inesperado: {error_data}"
            else:
    ...
    def test_password_hashing(self):
        ...
        with self.client.application.app_context():
            ...
            assert len(password_hash.split('$')) >= 2 or 'pbkdf2:sha256:' in password_hash, \
    ...
    def test_secure_headers(self):
        ...
        self.assertFalse(missing_headers, 
        ...
        if 'Content-Type' in response.headers:
            ...
            self.assertIn(content_type, ['application/json', 'text/html', 'text/html; charset=utf-8'],
    ...
    def test_error_handling(self):
        ...
        sensitive_terms = [
            ...
            'sql', 'syntax', 'table', 'database', 'column', 'index',
            # Términos de sistema de archivos
            'file', 'path', 'directory', 'permission', 'os',
            # Términos de red
            'host', 'port', 'connection', 'timeout',
