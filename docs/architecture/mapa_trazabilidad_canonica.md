...
| Modelo de Tres Cuentas (CDD/CEH/TED) | 16 §16.3 | `app/micromax_bp.py::/cdd`, `/dashboard`; UI `frontend/app/micromax/page.tsx` | `tests/test_micromax.py` | `8edc059`, `6089308`–`da24f94` (segmentos) |
