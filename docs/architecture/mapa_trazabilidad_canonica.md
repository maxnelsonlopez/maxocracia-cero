...
| Modelo de Tres Cuentas (CDD/CEH/TED) | 16 §16.3 + **16.5** (rama canónica: vector [T,V,R], CEH→TVI vendido, pesos p₁/p₂/p₃; §16.5.12 Modo Escudo + Red de Apoyo; **§16.5.13** roommates y conjuntos residenciales como unidades de convivencia) | `app/micromax_bp.py::/cdd`, `/dashboard`; UI `frontend/app/micromax/page.tsx` | `tests/test_micromax.py` | `8edc059`, `6089308`–`da24f94` (segmentos), `ce44182` (Modo Escudo), `f9697a5` (compatibilidad canónica) |
