...
| **B7 — Biblioteca privada** ✅ (04-09-2026, a petición de Max: sus PDFs de Springer en casa) | `ingest_pdfs.py` (pypdf, idempotente por hash, cifrado se omite) + fragmentos FTS5 sin filtrar texto | ingesta, idempotencia, fragmento-corto, cifrado-omitido — **implementado; 4 tests, plataforma 156/156, verificado en vivo (PDF demo → fragmento 155 chars, base limpia)** |
