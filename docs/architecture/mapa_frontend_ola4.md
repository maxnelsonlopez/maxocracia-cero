...
| `/talleres` | ~450 | `/workshops` (GET/POST), `**/workshops/tree**` (29-08: tejido visible), `/workshops/{id}`, `/enroll`, `/outputs`, `/grant-skill` (modal triada 29-08), `/close` | workshops + motor de vacuación (M3) |
