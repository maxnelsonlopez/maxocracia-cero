...
```mermaid
graph TD
    A[Paper 1: Fundacional] --> B[8 Axiomas de la Verdad]
    A --> C[TVI + VHV + SDV]
    A --> D[Tres Reinos]
    
    B --> E[Paper 2: Arquitectura Temporal]
    E --> F[13 Axiomas Temporales]
    E --> G[TVI como NFT Existencial]
    E --> H[PIU - Protocolo Inter-Reinos]
    
    C --> I[Paper 3: Ontometría Vital]
    I --> J[Medición Práctica VHV]
    I --> K[Protocolos Adaptativos]
    I --> L[Casos de Uso Reales]
```
